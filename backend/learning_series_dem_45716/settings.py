"""
Django settings for learning_series_dem_45716 project.
...
ROOT_URLCONF = 'learning_series_dem_45716.urls'
...
WSGI_APPLICATION = 'learning_series_dem_45716.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "learning_series_dem_45716 API",
    "DESCRIPTION": "API documentation for learning_series_dem_45716 App",
    "VERSION": "v1",
}
